...
struct FAuraGameplayTags FAuraGameplayTags::GameplayTags;

void FAuraGameplayTags::InitialGameplayTags()
{
	...
	GameplayTags.Damage_Fire = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Damage.Fire"),
		FString("Tag for calculating damage of fire")
	);

	GameplayTags.Damage_Lightning = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Damage.Lightning"),
		FString("Tag for calculating damage of Lightning")
	);

	GameplayTags.Damage_Arcane = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Damage.Arcane"),
		FString("Tag for calculating damage of Arcane")
	);

	GameplayTags.Damage_Physics = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Damage.Physics"),
		FString("Tag for calculating damage of Physics")
	);
	...
	GameplayTags.Debuff_Physics = UGameplayTagsManager::Get().AddNativeGameplayTag(
	...
	//Map from damagetype to resistance
	...
	//Map from damagetype to debuff
	GameplayTags.DamageTypesToDebuffs.Add(GameplayTags.Damage_Fire, GameplayTags.Debuff_Burn);
	GameplayTags.DamageTypesToDebuffs.Add(GameplayTags.Damage_Arcane, GameplayTags.Debuff_Arcane);
	GameplayTags.DamageTypesToDebuffs.Add(GameplayTags.Damage_Physics, GameplayTags.Debuff_Physics);
	...
	GameplayTags.Abilities_Attack = UGameplayTagsManager::Get().AddNativeGameplayTag(
		...
		FString("Tag for enemy attack")
	);

	GameplayTags.Abilities_Summon = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Abilities.Summon"),
		FString("Tag for enemy summon")
	);
	...
	GameplayTags.Abilities_Fire_Fireblast = UGameplayTagsManager::Get().AddNativeGameplayTag(
		...
		FString("Tag for spell the fireblast")
	);
    ...
    */
	...
	GameplayTags.GameplayCue_FireBlast = UGameplayTagsManager::Get().AddNativeGameplayTag(
		...
		FString("GameplayCue for Fire Blast")
	);
